...
(flet ((complex-displaced-p (x) (typep x '(and array (satisfies array-displacement))))
       (complex-undisplaced-p (x) (typep x '(and array (not simple-array) (not (satisfies array-displacement)))))
       (undisplaced-p (x) (typep x '(and array (not (satisfies array-displacement))))))
  (assert (complex-displaced-p (make-array 1 :displaced-to #(2))))
  (assert (not (complex-displaced-p (make-array 1 :adjustable t))))
  (assert (not (complex-displaced-p (make-array 1))))
  (assert (not (complex-displaced-p (make-array '(1 1)))))
  (assert (not (complex-undisplaced-p (make-array 1 :displaced-to #(2)))))
  (assert (complex-undisplaced-p (make-array 1 :adjustable t)))
  (assert (not (complex-undisplaced-p (make-array 1))))
  (assert (not (complex-undisplaced-p (make-array '(1 1)))))
  (assert (not (undisplaced-p (make-array 1 :displaced-to #(2)))))
  (assert (undisplaced-p (make-array 1 :adjustable t)))
  (assert (undisplaced-p (make-array 1)))
  (assert (undisplaced-p (make-array '(1 1)))))
;;; success
